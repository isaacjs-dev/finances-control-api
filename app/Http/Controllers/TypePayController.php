...
class TypePayController extends Controller
{
    ...
    public function createTypePay(Request $request)
    {
        $typePay = new TypePay();
    ...
    public function readAllTypesPay()
    {
        $response['error']['status'] = false;
    ...
    public function readTypePay($id)
    {
        $response['error']['status'] = false;
    ...
    public function updateTypePay(Request $request, $id)
    {
        $response['error']['status'] = false;
